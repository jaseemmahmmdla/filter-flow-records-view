      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            role="combobox"
            aria-expanded={open}
            className="w-full h-14 justify-between text-left font-normal !bg-white border-2 border-gray-200 hover:border-gray-300 focus:border-gray-400 !focus:bg-white focus-visible:!ring-0 focus-visible:!ring-offset-0 data-[state=open]:border-gray-400 data-[state=open]:!bg-white shadow-sm hover:shadow-md transition-all duration-200 [&:focus]:!bg-white [&[data-state=open]]:!bg-white"
          >
